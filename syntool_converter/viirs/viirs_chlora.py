...
import syntool_converter.utils.viirs as viirs
...
## For old VIIRS L2 OC (ie. V*.L2_NPP_OC.nc)
# swath size : ~576.00km x ~3104.04km
# 100km ngcps=(7, 32)
## For new VIIRS L2 OC (ie. V*.L2_SNPP_OC.nc)
# swath size : ~2436.00km x ~3104.04km
# 100km ngcps=(26, 32)
# viirs_chlora('V2015062114540', '/mnt/data/syntool_inputs/synergy/',
#              download_dir='/mnt/data/viirs')

def viirs_chlora(infileid, outdir, download_dir='/tmp',
                 vmin=None, vmax=None, contrast='relative',
                 ngcps=(26, 32), open_iterations=1,
    ...
    if contrast == 'relative':
        ...
        metadata['name'] = '{}_{}'.format(os.path.splitext(os.path.basename(viirsocfname))[0], contrast)
